    ...
    <div class="container">
        ...
        <form action="/projet/teams/edit/<?php echo $team['id']; ?>" method="POST" class="form">
            ...
            <div class="form-group">
                ...
                <textarea id="taches" name="taches" required><?php echo htmlspecialchars($team['taches']); ?></textarea>
            </div>

            <div class="form-group">
                <label for="etat">État :</label>
                <input type="color" id="etat" name="etat" required 
                       value="<?php echo htmlspecialchars($team['etat']); ?>">
            </div>
